...
export const Footer: React.FC = () => {
  return (
    <footer className="border-t border-slate-100 dark:border-zinc-900 bg-slate-50/50 dark:bg-zinc-950/20 py-16 transition-colors duration-300 font-sans">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              <a href="#" className="p-2 rounded-lg bg-white dark:bg-zinc-900 border border-slate-150 dark:border-zinc-800 text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 transition-colors">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2">
              ...
              />
              <Button variant="primary" size="sm" className="px-3.5">Join</Button>
            </div>
          </div>
        </div>
